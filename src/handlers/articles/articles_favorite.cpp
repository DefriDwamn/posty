...
namespace posty::handlers::articles_favorite::post {
...
userver::formats::json::Value Handler::HandleRequestJsonThrow(
    ...
    const auto get_article_res = GetPg().Execute(
        ...
        posty::sql::kGetArticleWithAuthorProfileBySlug,
        slug,
        user_id
    );
    ...
    builder["article"] = get_article_res.AsSingleRow<posty::models::TaggedArticleWithProfile>();
