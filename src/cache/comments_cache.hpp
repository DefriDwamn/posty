...
public:
    using Key = posty::models::CommentId;
    using Comment = posty::models::CachedComment;
...
struct CommentCachePolicy {
    ...
    using ValueType = posty::models::CachedComment;
    using CacheContainer = CommentsCacheContainer;
    static constexpr auto kKeyMember = &posty::models::CachedComment::id;
