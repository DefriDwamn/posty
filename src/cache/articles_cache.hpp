...
namespace posty::cache::articles_cache {
...
public:
    using Key = posty::models::ArticleId;
    using Article = posty::models::FullArticleInfo;
    ...
    std::vector<ArticlePtr> getRecent(posty::handlers::ArticleFilterDTO& filter_) const;
    std::vector<ArticlePtr> getFeed(posty::handlers::FeedArticleFilterDTO& filter_, UserId authId_) const;
