...
userver::storages::postgres::Query ArticlesCachePolicy::kQuery = posty::sql::kSelectFullArticleInfo;
...
std::vector<ArticlesCacheContainer::ArticlePtr> ArticlesCacheContainer::getRecent(
    posty::handlers::ArticleFilterDTO& filter
) const {
...
ArticlesCacheContainer::getFeed(posty::handlers::FeedArticleFilterDTO& filter, UserId auth_id) const {
